...
class BottomSheetUtil {
  ...
  static Container _distanceDiscription(BuildContext context) {
    return Container(
  ...
  static Row _appbar(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        _buttonText(context, () => Navigator.pop(context), false),
      ],
    );
  }
